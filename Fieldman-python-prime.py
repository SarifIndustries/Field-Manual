# Sublime quick-run: CM + B
# Sublime delete-line: CTRL+SHIFT+K


# Only what needed
# Python: easy quickscript, optimistically, step-by-step execution
# Variables style: snake_case, Blocks: 4 space indentation
# Runs and checks line-by-line (runtime errors onlu)
...
# Console Input (can use redirects of standard input)
